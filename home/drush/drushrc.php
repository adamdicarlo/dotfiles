...
$options['skip-tables'] = array(
  ...
  'solar' => array(
    ...
    'devel_queries',
    'devel_times',
    'fat_spaniel_asset_category',
    'fat_spaniel_customer',
    'fat_spaniel_data_bins_day',
    'fat_spaniel_data_bins_hour',
    'fat_spaniel_data_bins_month',
    'fat_spaniel_data_bins_year',
    'fat_spaniel_data_summary',
    'fat_spaniel_device',
    'fat_spaniel_entity_fields',
    'fat_spaniel_logger',
    'fat_spaniel_site'
  ),
);
